...
public class mainApp {
	public static void main(String[] args) throws Exception {
		...
		/*
		 * Student student1 = new Student(); student1.setName("stu4");
		 * student1.setAge(18);
		 * 
		 * Student student2 = new Student(); student2.setName("stu5");
		 * student2.setAge(17);
		 * 
		 * Student student3 = new Student(); student3.setName("stu6");
		 * student3.setAge(15);
		 * 
		 * 
		 * studentService.saveAll(new ArrayList<>(Arrays.asList(student1, student2,
		 * student3)));
		 */
